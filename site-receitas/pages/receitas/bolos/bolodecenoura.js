    ...
    return(
        ...
        <main>
            <article className="recipe-body" >
                ...
                <img className="recipe-body-picture" alt="Bolo de Cenoura" src="https://s2.glbimg.com/mVrs_HXux7pgYIt7xotYUg_0d5A=/0x0:1550x1200/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_e84042ef78cb4708aeebdf1c68c6cbd6/internal_photos/bs/2020/q/j/gkbXFDTk2WK7TznmMO7Q/bolo-de-cenoura-de-liquidificador.jpg"/>

                <div>
                    <i className="fas fa-stopwatch fa-fw"  ></i> Preparo: 30min <br/>
                    <i className="fas fa-utensils fa-fw" ></i> Rendimento: 10 porções 
                </div>
